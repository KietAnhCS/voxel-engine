package st.rhapsody.voxelengine.lib;
...
import st.rhapsody.voxelengine.lib.physics.CameraController;
...
public class VoxelEngine {
    ...
    public void render(float delta) {
        ...
        // Camera controller sau physics (giữ đúng direction)
    ...
    private void renderVoxelBatch() {
        if (!this.world.isPlayerInWater(this.camera)) {
            this.shaderProgram.bind();
            this.shaderProgram.setUniformf("u_fogstr", 0.04F);
            this.environment.set(this.skyFogColorAttribute);
        } else {
            this.shaderProgram.bind();
            this.shaderProgram.setUniformf("u_fogstr", 0.1F);
            this.environment.set(this.fogColorAttribute);
            Gdx.gl.glClearColor(this.waterFog.r, this.waterFog.g, this.waterFog.b, this.waterFog.a);
        }
    ...
    private void setupCameraController() {
        ...
        cameraController.setVelocity(0.020f);
