package st.rhapsody.voxelengine.lib.terrain.noise;/*
 ...
 *
 * Changed to support seeds based on various forums posts on Internet.
 *
 *
 */
...
public class SimplexNoise2 {  // Simplex noise in 2D, 3D and 4D
    ...
    private static final short[] p_init = {151, 160, 137, 91, 90, 15,
    ...
    private static short p[] = new short[p_init.length];
