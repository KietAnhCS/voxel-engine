 ...
 *   - O khoi nguoi khac dat/pha -> XEP HANG doi vao {@link #pendingEdits}, vi sua the gioi phai
 *     lam tren luong game (dung mesh), khong lam duoc tren luong WebSocket.
 *
...
public final class WorldClient {
    ...
    private final RemotePlayers players = new RemotePlayers();
